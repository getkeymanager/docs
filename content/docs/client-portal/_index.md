...
### [Dashboard]({{< ref "/../../docs/docs/client-portal/dashboard" >}})
An at-a-glance summary of account health, total license counts, and recent activity updates.

### [My Licenses]({{< ref "/../../docs/docs/client-portal/licenses" >}})
