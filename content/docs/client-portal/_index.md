...
### [Dashboard]({{< ref "/docs/docs/content/docs/client-portal/dashboard" >}})
An at-a-glance summary of account health, total license counts, and recent activity updates.

### [My Licenses]({{< ref "/docs/docs/content/docs/client-portal/licenses" >}})
...
1. **Login**: Access the customer portal with your credentials
2. **Dashboard**: View your license summary
3. **My Licenses**: Check your license details
4. **Activations**: Manage your device activations
5. **Downloads**: Access your entitled downloads
