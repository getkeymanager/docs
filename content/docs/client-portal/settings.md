...
- **Not Receiving Emails**: 
    ...
    - Verify your account email address on the [Profile]({{< ref "/content/docs/client-portal/profile" >}}) page.
...
- [Profile]({{< ref "/content/docs/client-portal/profile" >}}) - Update your name and manage your account password.
- [Dashboard]({{< ref "/content/docs/client-portal/dashboard" >}}) - View the results of your personalized timezone and theme settings.
