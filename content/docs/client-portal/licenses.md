...
- **Activation Limit Error**: If you see a "Limit Reached" error in the Validation Status, navigate to the [Activations]({{< ref "/content/docs/client-portal/activations" >}}) page to deactivate an old device.
...
- [Dashboard]({{< ref "/content/docs/client-portal/dashboard" >}}) - Overview of recent license activity.
- [Activations]({{< ref "/content/docs/client-portal/activations" >}}) - Manage individual device registrations.
- [Downloads]({{< ref "/content/docs/client-portal/downloads" >}}) - Access software restricted by your licenses.
