...
- [Dashboard]({{< ref "/content/docs/client-portal/dashboard" >}}) - View total activation counts.
- [My Licenses]({{< ref "/content/docs/client-portal/licenses" >}}) - Check the activation limits for each of your products.
