...
- [Dashboard]({{< ref "/docs/docs/content/docs/client-portal/dashboard" >}}) - View total activation counts.
- [My Licenses]({{< ref "/docs/docs/content/docs/client-portal/licenses" >}}) - Check the activation limits for each of your products.
