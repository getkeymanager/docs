...
* **Monitor login activity** in [Logs]({{< ref "/docs/content/docs/admin-portal/logs" >}})
...
* [Logs]({{< ref "/docs/content/docs/admin-portal/logs" >}}) — View admin activity and login history
* [Settings]({{< ref "/docs/content/docs/admin-portal/settings" >}}) — System configuration (Super Admin only)
