...
* **Monitor login activity** in [Logs]({{< ref "/content/docs/admin-portal/logs" >}})
...
* [Logs]({{< ref "/content/docs/admin-portal/logs" >}}) — View admin activity and login history
* [Settings]({{< ref "/content/docs/admin-portal/settings" >}}) — System configuration (Super Admin only)
