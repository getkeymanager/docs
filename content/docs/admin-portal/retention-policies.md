...
* [System Logs](../logs) — View the data being managed by these policies
* [Settings → Audit Trails](../settings) — View the permanent history that is never purged
* [Background Jobs](../background-jobs) — Monitor the status of the purge tasks
