...
* [System Logs]({{< ref "/docs/content/docs/admin-portal/logs" >}}) — View the data being managed by these policies
* [Settings → Audit Trails]({{< ref "/docs/content/docs/admin-portal/settings" >}}) — View the permanent history that is never purged
* [Background Jobs]({{< ref "/docs/content/docs/admin-portal/background-jobs" >}}) — Monitor the status of the purge tasks
