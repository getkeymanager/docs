...
- [Widgets](../widgets) - Create and manage custom dashboard widgets
- [Telemetry](../telemetry) - View detailed telemetry data feeding dashboard charts
- [Logs](../logs) - Full activity log with advanced filtering (feeds Recent Activity)
- [Products](../products) - Manage products shown in dashboard charts
- [Licenses](../licenses) - View detailed license data behind KPI cards
- [Settings](../settings) - Configure dashboard behavior and data collection
- [Profile](../profile) - Customize your personal dashboard preferences
