...
*   **Automatic Retries**: Based on your [system settings]({{< ref "/docs/content/docs/admin-portal/settings" >}}), the platform will automatically attempt to re-send the data with exponential backoff.
...
*   **Data Retention**: Delivery logs are automatically purged after 30 days to optimize database performance. See [Retention Policies]({{< ref "/docs/content/docs/admin-portal/retention-policies" >}}).
...
*   [Webhooks]({{< ref "/docs/content/docs/admin-portal/webhooks" >}}) — Create and manage your webhook configurations.
*   [Data Retention Policies]({{< ref "/docs/content/docs/admin-portal/retention-policies" >}}) — Configure how long these logs are kept.
*   [Logs]({{< ref "/docs/content/docs/admin-portal/logs" >}}) — View high-level system activity including webhook job starts.
