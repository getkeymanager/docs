...
**Monitor Activity:**
- Go to [Logs]({{< ref "/docs/docs/content/docs/admin-portal/logs" >}}) to check your activity
...
4. Check [Logs]({{< ref "/docs/docs/content/docs/admin-portal/logs" >}}) for any unfamiliar login IPs
5. Review [Admin Users]({{< ref "/docs/docs/content/docs/admin-portal/admins" >}}) page for unauthorized accounts
...
* [Admin Users]({{< ref "/docs/docs/content/docs/admin-portal/admins" >}}) — View all admin accounts (Super Admin only)
* [Logs]({{< ref "/docs/docs/content/docs/admin-portal/logs" >}}) — Check your account activity
* [Settings]({{< ref "/docs/docs/content/docs/admin-portal/settings" >}}) — System-wide configuration (Super Admin only)
