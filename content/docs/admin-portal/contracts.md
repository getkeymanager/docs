...
- Link to [Licenses]({{< ref "/docs/content/docs/admin-portal/licenses" >}}) page filtered by this contract
...
7. Monitor progress in [Background Jobs]({{< ref "/docs/content/docs/admin-portal/background-jobs" >}})
8. Generated licenses appear in [Licenses]({{< ref "/docs/content/docs/admin-portal/licenses" >}}) page with source = "Contract"
...
3. **Test Generation**
   ...
   - Check license appears in [Licenses]({{< ref "/docs/content/docs/admin-portal/licenses" >}}) with source "Contract: TechReseller Inc..."
...
6. **Monitor Usage**
   ...
   - Check for API errors or rate limit violations in [Logs]({{< ref "/docs/content/docs/admin-portal/logs" >}})
...
3. **Monitor Generation**
   - Go to [Background Jobs]({{< ref "/docs/content/docs/admin-portal/background-jobs" >}})
   - Find job by ID
...
3. **Verify Pool**
   - Go to [Licenses]({{< ref "/docs/content/docs/admin-portal/licenses" >}})
...
- Event logged in [Logs]({{< ref "/docs/content/docs/admin-portal/logs" >}})
...
3. Or: Go to [Licenses]({{< ref "/docs/content/docs/admin-portal/licenses" >}}) → Filter by contract → Export CSV
...
**Solution:** Verify API key copied correctly (no extra spaces). Check contract status is Active. Verify IP allowlist (if configured) includes reseller's IP. Check rate limits not exceeded. Review [Logs]({{< ref "/docs/content/docs/admin-portal/logs" >}}) for specific API error messages.
...
**Solution:** Verify background job completed successfully (check [Background Jobs]({{< ref "/docs/content/docs/admin-portal/background-jobs" >}})). If job failed, review error message. Common causes: Product inactive, generator deleted, database issues. May need to regenerate.
...
* [Licenses]({{< ref "/docs/content/docs/admin-portal/licenses" >}}) — View licenses generated from contracts
* [Generators]({{< ref "/docs/content/docs/admin-portal/generators" >}}) — Configure license generation rules used by contracts
* [Background Jobs]({{< ref "/docs/content/docs/admin-portal/background-jobs" >}}) — Monitor bulk license generation progress
* [Customers]({{< ref "/docs/content/docs/admin-portal/customers" >}}) — Assign contract licenses to customers
* [API Keys]({{< ref "/docs/content/docs/admin-portal/api-keys" >}}) — Manage admin API keys (different from contract API keys)
* [Logs]({{< ref "/docs/content/docs/admin-portal/logs" >}}) — Audit contract activity and API calls
