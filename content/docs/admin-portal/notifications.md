...
- **Email Delivery**: If you are not receiving email mirrors for notifications, verify your email address in the [Profile]({{< ref "/content/docs/admin-portal/profile" >}}) page and check your system's SMTP configuration.
...
- [Dashboard]({{< ref "/content/docs/admin-portal/dashboard" >}}) - Summary of system health.
- [Profile]({{< ref "/content/docs/admin-portal/profile" >}}) - Manage your personal notification preferences.
- [Logs]({{< ref "/content/docs/admin-portal/logs" >}}) - Deep dive into system-level events and errors.
