...
- **Email Delivery**: If you are not receiving email mirrors for notifications, verify your email address in the [Profile]({{< ref "/../docs/admin-portal/profile" >}}) page and check your system's SMTP configuration.
...
- [Dashboard]({{< ref "/../docs/admin-portal/dashboard" >}}) - Summary of system health.
- [Profile]({{< ref "/../docs/admin-portal/profile" >}}) - Manage your personal notification preferences.
- [Logs]({{< ref "/../docs/admin-portal/logs" >}}) - Deep dive into system-level events and errors.
