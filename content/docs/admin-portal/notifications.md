...
- **Email Delivery**: If you are not receiving email mirrors for notifications, verify your email address in the [Profile](../profile) page and check your system's SMTP configuration.
...
- [Dashboard](../dashboard) - Summary of system health.
- [Profile](../profile) - Manage your personal notification preferences.
- [Logs](../logs) - Deep dive into system-level events and errors.
