...
* **Access the [Client Portal](../../client-portal/dashboard)** to manage their licenses and activations
...
- Used for login to [Client Portal](../../client-portal/dashboard)
...
- **Quick Actions:**
  ...
  - **View All in Licenses Page** — Opens [Licenses](../licenses) filtered by this customer
...
- Link to [Activations](../activations) page filtered by customer
...
9. Customer sees their license(s) in [Client Portal](../../client-portal/licenses)
...
| **Portal Access** | [Client Portal](../../client-portal/dashboard) | [Admin Portal](../dashboard) |
...
1. **Go to Licenses Page** (Not Customers page)
   - [Licenses](../licenses) page has better filtering for this
...
- Licenses have separate retention (see [Retention Policies](../retention-policies))
- Logs may be auto-purged (see [Retention Policies](../retention-policies))
...
- Verify email settings configured in [Settings > Email](../settings)
- Check [Logs](../logs) for email send failures
...
Go to [Licenses](../licenses) page (better filtering), not Customers page. Filter by expiry date range. Export list of customer emails. Cross-reference with Customers page for contact info.
...
Only if email notifications are configured in [Settings > Email](../settings) and "Send email on license issue" is enabled for the product. Otherwise, no automatic notification.

---

## Related Pages

* [Licenses](../licenses) — Assign licenses to customers, bulk operations
* [Activations](../activations) — View customer device activations and usage
* [Client Portal](../../client-portal/dashboard) — What customers see (their perspective)
* [Settings > Email](../settings) — Configure customer invitation and notification emails
* [Logs](../logs) — Audit customer activity, logins, and actions
