...
* **Access the [Client Portal]({{< ref "/content/docs/admin-portal/../client-portal/dashboard" >}})** to manage their licenses and activations
...
- Used for login to [Client Portal]({{< ref "/content/docs/admin-portal/../client-portal/dashboard" >}})
...
- **Quick Actions:**
  ...
  - **View All in Licenses Page** — Opens [Licenses]({{< ref "/content/docs/admin-portal/licenses" >}}) filtered by this customer
...
- Link to [Activations]({{< ref "/content/docs/admin-portal/activations" >}}) page filtered by customer
...
9. Customer sees their license(s) in [Client Portal]({{< ref "/content/docs/admin-portal/../client-portal/licenses" >}})
...
| **Portal Access** | [Client Portal]({{< ref "/content/docs/admin-portal/../client-portal/dashboard" >}}) | [Admin Portal]({{< ref "/content/docs/admin-portal/dashboard" >}}) |
...
1. **Go to Licenses Page** (Not Customers page)
   - [Licenses]({{< ref "/content/docs/admin-portal/licenses" >}}) page has better filtering for this
...
- Licenses have separate retention (see [Retention Policies]({{< ref "/content/docs/admin-portal/retention-policies" >}}))
- Logs may be auto-purged (see [Retention Policies]({{< ref "/content/docs/admin-portal/retention-policies" >}}))
...
- Check [Logs]({{< ref "/content/docs/admin-portal/logs" >}}) for authentication errors
...
- Verify email settings configured in [Settings > Email]({{< ref "/content/docs/admin-portal/settings" >}})
- Check [Logs]({{< ref "/content/docs/admin-portal/logs" >}}) for email send failures
...
Go to [Licenses]({{< ref "/content/docs/admin-portal/licenses" >}}) page (better filtering), not Customers page. Filter by expiry date range. Export list of customer emails. Cross-reference with Customers page for contact info.
...
Only if email notifications are configured in [Settings > Email]({{< ref "/content/docs/admin-portal/settings" >}}) and "Send email on license issue" is enabled for the product. Otherwise, no automatic notification.

---

## Related Pages

* [Licenses]({{< ref "/content/docs/admin-portal/licenses" >}}) — Assign licenses to customers, bulk operations
* [Activations]({{< ref "/content/docs/admin-portal/activations" >}}) — View customer device activations and usage
* [Client Portal]({{< ref "/content/docs/admin-portal/../client-portal/dashboard" >}}) — What customers see (their perspective)
* [Settings > Email]({{< ref "/content/docs/admin-portal/settings" >}}) — Configure customer invitation and notification emails
* [Logs]({{< ref "/content/docs/admin-portal/logs" >}}) — Audit customer activity, logins, and actions
