...
- **Emails Not Sending**:
    ...
    - Check the system's SMTP or Mail Driver configuration in the global [Settings]({{< ref "/content/docs/admin-portal/settings" >}}).
    - Review the [Background Jobs]({{< ref "/content/docs/admin-portal/background-jobs" >}}) queue to ensure email delivery tasks are completing successfully.
...
- [Settings]({{< ref "/content/docs/admin-portal/settings" >}}) - Configure global mail drivers.
- [Logs]({{< ref "/content/docs/admin-portal/logs" >}}) - Check for email delivery errors.
- [Background Jobs]({{< ref "/content/docs/admin-portal/background-jobs" >}}) - Monitor the mail delivery queue.
