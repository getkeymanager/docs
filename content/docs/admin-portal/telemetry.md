...
6. **Action:** If a single license key is responsible for 1,000s of flagged records, go to [License Keys]({{< ref "/../../docs/docs/admin-portal/licenses" >}}) and **Revoke** that key immediately.
...
2. Check your [API Logs]({{< ref "/../../docs/docs/admin-portal/logs" >}}) for failed `/api/v1/telemetry` calls.
...
* [Dashboard]({{< ref "/../../docs/docs/admin-portal/dashboard" >}}) — View simplified telemetry widgets
* [License Keys]({{< ref "/../../docs/docs/admin-portal/licenses" >}}) — Link telemetry back to specific users
* [Data Retention Policies]({{< ref "/../../docs/docs/admin-portal/retention-policies" >}}) — Configure when old telemetry is purged
* [System Logs]({{< ref "/../../docs/docs/admin-portal/logs" >}}) — Audit the telemetry receiving process
