...
6. **Action:** If a single license key is responsible for 1,000s of flagged records, go to [License Keys]({{< ref "/content/docs/admin-portal/licenses" >}}) and **Revoke** that key immediately.
...
2. Check your [API Logs]({{< ref "/content/docs/admin-portal/logs" >}}) for failed `/api/v1/telemetry` calls.
...
* [Dashboard]({{< ref "/content/docs/admin-portal/dashboard" >}}) — View simplified telemetry widgets
* [License Keys]({{< ref "/content/docs/admin-portal/licenses" >}}) — Link telemetry back to specific users
* [Data Retention Policies]({{< ref "/content/docs/admin-portal/retention-policies" >}}) — Configure when old telemetry is purged
* [System Logs]({{< ref "/content/docs/admin-portal/logs" >}}) — Audit the telemetry receiving process
