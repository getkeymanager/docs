...
6. **Action:** If a single license key is responsible for 1,000s of flagged records, go to [License Keys](../licenses) and **Revoke** that key immediately.
...
2. Check your [API Logs](../logs) for failed `/api/v1/telemetry` calls.
...
* [Dashboard](../dashboard) — View simplified telemetry widgets
* [License Keys](../licenses) — Link telemetry back to specific users
* [Data Retention Policies](../retention-policies) — Configure when old telemetry is purged
* [System Logs](../logs) — Audit the telemetry receiving process
