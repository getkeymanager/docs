...
8. **Save**.
9. Go to your [Dashboard](../dashboard) to see the new chart.
...
- Ensure [Telemetry](../telemetry) is actually being received for that product.

---

## Related Pages

* [Dashboard](../dashboard) — View your configured widgets in action
* [Telemetry](../telemetry) — Sources for custom widget data
* [Products](../products) — Map widgets to specific software assets
