...
8. **Save**.
9. Go to your [Dashboard]({{< ref "/docs/content/docs/admin-portal/dashboard" >}}) to see the new chart.
...
- Ensure [Telemetry]({{< ref "/docs/content/docs/admin-portal/telemetry" >}}) is actually being received for that product.

---

## Related Pages

* [Dashboard]({{< ref "/docs/content/docs/admin-portal/dashboard" >}}) — View your configured widgets in action
* [Telemetry]({{< ref "/docs/content/docs/admin-portal/telemetry" >}}) — Sources for custom widget data
* [Products]({{< ref "/docs/content/docs/admin-portal/products" >}}) — Map widgets to specific software assets
