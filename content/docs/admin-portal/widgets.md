...
8. **Save**.
9. Go to your [Dashboard]({{< ref "/content/docs/admin-portal/dashboard" >}}) to see the new chart.
...
- Ensure [Telemetry]({{< ref "/content/docs/admin-portal/telemetry" >}}) is actually being received for that product.

---

## Related Pages

* [Dashboard]({{< ref "/content/docs/admin-portal/dashboard" >}}) — View your configured widgets in action
* [Telemetry]({{< ref "/content/docs/admin-portal/telemetry" >}}) — Sources for custom widget data
* [Products]({{< ref "/content/docs/admin-portal/products" >}}) — Map widgets to specific software assets
