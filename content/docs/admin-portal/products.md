...
- Requires Email settings to be configured in [Settings > Email]({{< ref "/docs/content/docs/admin-portal/settings" >}})
- Can be toggled later
...
8. Next: Create a [Generator]({{< ref "/docs/content/docs/admin-portal/generators" >}}) for this product
9. Next: Create [Licenses]({{< ref "/docs/content/docs/admin-portal/licenses" >}}) for testing
...
5. Click **Create Product**
6. Go to [Settings > Envato]({{< ref "/docs/content/docs/admin-portal/settings" >}}) to configure API credentials
...
12. Monitor [Telemetry]({{< ref "/docs/content/docs/admin-portal/telemetry" >}}) and [Logs]({{< ref "/docs/content/docs/admin-portal/logs" >}}) for verification failures
...
10. Go to [Licenses]({{< ref "/docs/content/docs/admin-portal/licenses" >}}) page
...
3. Create a [Generator]({{< ref "/docs/content/docs/admin-portal/generators" >}}) for the product
...
- If problem persists, check [Logs]({{< ref "/docs/content/docs/admin-portal/logs" >}}) for errors
...
- They must be configured in the [Generator]({{< ref "/docs/content/docs/admin-portal/generators" >}}) for the product
...
**Solution:**
- Check [Settings > S3]({{< ref "/docs/content/docs/admin-portal/settings" >}}) configuration is correct
...
- Check [Background Jobs]({{< ref "/docs/content/docs/admin-portal/background-jobs" >}}) page for job status
- Refresh license list after 1-2 minutes
- If still not working, check [Logs]({{< ref "/docs/content/docs/admin-portal/logs" >}}) for errors
...
- **[License Generators]({{< ref "/docs/content/docs/admin-portal/generators" >}})** — Configure how licenses are created for this product
- **[License Keys]({{< ref "/docs/content/docs/admin-portal/licenses" >}})** — View and manage licenses generated for this product
- **[Downloadables]({{< ref "/docs/content/docs/admin-portal/downloadables" >}})** — Add product files/updates that customers can download
- **[Settings > S3]({{< ref "/docs/content/docs/admin-portal/settings" >}})** — Configure image storage for product logos
- **[Settings > Envato]({{< ref "/docs/content/docs/admin-portal/settings" >}})** — Set up Envato marketplace integration
- **[Telemetry]({{< ref "/docs/content/docs/admin-portal/telemetry" >}})** — Monitor product usage and license verification patterns
...
- [License Generators]({{< ref "/docs/content/docs/admin-portal/generators" >}}) - Configure license creation rules
- [License Keys]({{< ref "/docs/content/docs/admin-portal/licenses" >}}) - View and manage all licenses
- [Settings]({{< ref "/docs/content/docs/admin-portal/settings" >}}) - System-wide configuration
