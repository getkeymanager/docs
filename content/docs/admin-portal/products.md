...
- Requires Email settings to be configured in [Settings > Email](../settings)
- Can be toggled later
...
8. Next: Create a [Generator](../generators) for this product
9. Next: Create [Licenses](../licenses) for testing
...
5. Click **Create Product**
6. Go to [Settings > Envato](../settings) to configure API credentials
...
12. Monitor [Telemetry](../telemetry) and [Logs](../logs) for verification failures
...
10. Go to [Licenses](../licenses) page
...
3. Create a [Generator](../generators) for the product
...
- If problem persists, check [Logs](../logs) for errors
...
- They must be configured in the [Generator](../generators) for the product
...
**Solution:**
- Check [Settings > S3](../settings) configuration is correct
...
- Check [Background Jobs](../background-jobs) page for job status
- Refresh license list after 1-2 minutes
- If still not working, check [Logs](../logs) for errors
...
- **[License Generators](../generators)** — Configure how licenses are created for this product
- **[License Keys](../licenses)** — View and manage licenses generated for this product
- **[Downloadables](../downloadables)** — Add product files/updates that customers can download
- **[Settings > S3](../settings)** — Configure image storage for product logos
- **[Settings > Envato](../settings)** — Set up Envato marketplace integration
- **[Telemetry](../telemetry)** — Monitor product usage and license verification patterns
...
- [License Generators](../generators) - Configure license creation rules
- [License Keys](../licenses) - View and manage all licenses
