...
6. If suspicious:
   - Go to [Admin Users](../admins) and deactivate the account
...
5. Cross-reference with [Telemetry](../telemetry) if available

---

## Log Retention

Logs are **automatically purged** based on [retention policies](../retention-policies).
...
1. Go to [Settings → Retention Policies](../settings)
...
For **permanent, immutable records**, see [Audit Trails](../settings#audit-trails). These cannot be purged and maintain a complete history of all state-changing actions.
...
- Check [retention policy settings](../retention-policies)
- If older than retention, check [Audit Trails](../settings#audit-trails) instead
...
* [Admin Users](../admins) — Manage who has admin access
* [Settings → Retention Policies](../retention-policies) — Configure how long logs are kept
* [Settings → Audit Trails](../settings) — View immutable activity records
* [Profile](../profile) — Your admin account settings
* [Telemetry](../telemetry) — Usage analytics and piracy detection
