...
6. If suspicious:
   - Go to [Admin Users]({{< ref "/docs/content/docs/admin-portal/admins" >}}) and deactivate the account
...
5. Cross-reference with [Telemetry]({{< ref "/docs/content/docs/admin-portal/telemetry" >}}) if available

---

## Log Retention

Logs are **automatically purged** based on [retention policies]({{< ref "/docs/content/docs/admin-portal/retention-policies" >}}).
...
1. Go to [Settings → Retention Policies]({{< ref "/docs/content/docs/admin-portal/settings" >}})
...
For **permanent, immutable records**, see [Audit Trails]({{< ref "/docs/content/docs/admin-portal/settings#audit-trails" >}}). These cannot be purged and maintain a complete history of all state-changing actions.
...
- Check [retention policy settings]({{< ref "/docs/content/docs/admin-portal/retention-policies" >}})
- If older than retention, check [Audit Trails]({{< ref "/docs/content/docs/admin-portal/settings#audit-trails" >}}) instead
...
* [Admin Users]({{< ref "/docs/content/docs/admin-portal/admins" >}}) — Manage who has admin access
* [Settings → Retention Policies]({{< ref "/docs/content/docs/admin-portal/retention-policies" >}}) — Configure how long logs are kept
* [Settings → Audit Trails]({{< ref "/docs/content/docs/admin-portal/settings" >}}) — View immutable activity records
* [Profile]({{< ref "/docs/content/docs/admin-portal/profile" >}}) — Your admin account settings
* [Telemetry]({{< ref "/docs/content/docs/admin-portal/telemetry" >}}) — Usage analytics and piracy detection
