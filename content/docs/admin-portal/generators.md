...
**Related Admin Pages:**
* **[Products](../products)** — Create products before creating generators
* **[License Keys](../licenses)** — View licenses created by generators
* **[Contracts](../contracts)** — Automate license generation via contracts
* **[Background Jobs](../background-jobs)** — Monitor bulk generation progress
* **[Logs](../logs)** — Audit generator creation and usage

**Related Settings:**
* **[License Settings](../settings/license)** — Global license defaults
* **[General Settings](../settings/general)** — Environment configuration
...
**Next Steps:**
* Create your first generator: **[Products](../products)** → **Create Generator**
* Generate licenses: Actions menu → **Generate Licenses**
* Assign licenses to customers: **[License Keys](../licenses)** → **Assign**
