...
**Related Admin Pages:**
* **[Products]({{< ref "/docs/docs/content/docs/admin-portal/products" >}})** — Create products before creating generators
* **[License Keys]({{< ref "/docs/docs/content/docs/admin-portal/licenses" >}})** — View licenses created by generators
* **[Contracts]({{< ref "/docs/docs/content/docs/admin-portal/contracts" >}})** — Automate license generation via contracts
* **[Background Jobs]({{< ref "/docs/docs/content/docs/admin-portal/background-jobs" >}})** — Monitor bulk generation progress
* **[Logs]({{< ref "/docs/docs/content/docs/admin-portal/logs" >}})** — Audit generator creation and usage

**Related Settings:**
* **[License Settings]({{< ref "/docs/docs/content/docs/admin-portal/settings/license" >}})** — Global license defaults
* **[General Settings]({{< ref "/docs/docs/content/docs/admin-portal/settings/general" >}})** — Environment configuration
...
**Next Steps:**
* Create your first generator: **[Products]({{< ref "/docs/docs/content/docs/admin-portal/products" >}})** → **Create Generator**
* Generate licenses: Actions menu → **Generate Licenses**
* Assign licenses to customers: **[License Keys]({{< ref "/docs/docs/content/docs/admin-portal/licenses" >}})** → **Assign**
