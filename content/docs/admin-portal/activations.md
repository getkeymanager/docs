...
- Links to [License Details]({{< ref "/../docs/admin-portal/licenses" >}}) page (if clickable)
...
1. Customer downloads offline license file from [Client Portal]({{< ref "/../docs/admin-portal/../client-portal/licenses" >}})
...
Licenses can have **activation limits** (configured in [Generators]({{< ref "/../docs/admin-portal/generators" >}})):
...
- Deactivation can be done by:
  - Customer via [Client Portal]({{< ref "/../docs/admin-portal/../client-portal/activations" >}})
...
- Go to [Settings > Retention Policies]({{< ref "/../docs/admin-portal/retention-policies" >}})
...
5. **Check Logs:**
   - Go to [Logs]({{< ref "/../docs/admin-portal/logs" >}}) page
...
Every activation and deactivation is logged in the [Audit Trail]({{< ref "/../docs/admin-portal/logs" >}}):
...
4. **Set up automated policies** — Use [Retention Policies]({{< ref "/../docs/admin-portal/retention-policies" >}}) for auto-deactivation of old devices
...
10. **Cross-reference with telemetry** — Go to [Telemetry]({{< ref "/../docs/admin-portal/telemetry" >}}) page to see actual usage patterns
...
- Check parent license **Status** in [Licenses]({{< ref "/../docs/admin-portal/licenses" >}}) page: May be `expired`, `suspended`, or `revoked`
...
- Verify generator configuration: Activation limit may be set to 1 (check [Generators]({{< ref "/../docs/admin-portal/generators" >}}) page)
- Review license status: Suspended licenses may block new activations
- Check [Logs]({{< ref "/../docs/admin-portal/logs" >}}) for detailed error message from last activation attempt
...
- Check [Telemetry]({{< ref "/../docs/admin-portal/telemetry" >}}) page: If telemetry is arriving, license is in use even if not verifying
...
- Check [Logs]({{< ref "/../docs/admin-portal/logs" >}}) for specific error message
...
**Yes.** Customers can deactivate devices from the [Client Portal > Activations]({{< ref "/../docs/admin-portal/../client-portal/activations" >}}) page. This frees up activation slots without admin intervention.
...
When you revoke a license (via [Licenses]({{< ref "/../docs/admin-portal/licenses" >}}) page):
...
**Yes.** Go to [Logs > Audit Trail]({{< ref "/../docs/admin-portal/logs" >}}) and filter by:
- Action: "Deactivation"
...
**Revoke ([Licenses]({{< ref "/../docs/admin-portal/licenses" >}}) page):**
...
- **[License Keys]({{< ref "/../docs/admin-portal/licenses" >}})** — Manage the licenses that these activations belong to
- **[Customers]({{< ref "/../docs/admin-portal/customers" >}})** — View customer details and their licenses
- **[Telemetry]({{< ref "/../docs/admin-portal/telemetry" >}})** — See actual usage patterns beyond just activation
- **[Logs]({{< ref "/../docs/admin-portal/logs" >}})** — Review activation/deactivation events in detail
- **[Settings > Retention Policies]({{< ref "/../docs/admin-portal/retention-policies" >}})** — Configure auto-deactivation rules
...
- [License Keys]({{< ref "/../docs/admin-portal/licenses" >}}) - Manage licenses
- [Customers]({{< ref "/../docs/admin-portal/customers" >}}) - Customer management
- [Settings]({{< ref "/../docs/admin-portal/settings" >}}) - System configuration
