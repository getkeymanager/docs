...
- Links to [License Details](../licenses) page (if clickable)
...
1. Customer downloads offline license file from [Client Portal](../../client-portal/licenses)
...
Licenses can have **activation limits** (configured in [Generators](../generators)):
...
- Go to [Settings > Retention Policies](../retention-policies)
...
Every activation and deactivation is logged in the [Audit Trail](../logs):
...
4. **Set up automated policies** — Use [Retention Policies](../retention-policies) for auto-deactivation of old devices
...
10. **Cross-reference with telemetry** — Go to [Telemetry](../telemetry) page to see actual usage patterns
...
- Check parent license **Status** in [Licenses](../licenses) page: May be `expired`, `suspended`, or `revoked`
...
- Verify generator configuration: Activation limit may be set to 1 (check [Generators](../generators) page)
- Review license status: Suspended licenses may block new activations
- Check [Logs](../logs) for detailed error message from last activation attempt
...
- Check [Telemetry](../telemetry) page: If telemetry is arriving, license is in use even if not verifying
...
- Check [Logs](../logs) for specific error message
...
**Yes.** Customers can deactivate devices from the [Client Portal > Activations](../../client-portal/activations) page. This frees up activation slots without admin intervention.
...
When you revoke a license (via [Licenses](../licenses) page):
...
**Yes.** Go to [Logs > Audit Trail](../logs) and filter by:
- Action: "Deactivation"
...
- **[License Keys](../licenses)** — Manage the licenses that these activations belong to
- **[Customers](../customers)** — View customer details and their licenses
- **[Telemetry](../telemetry)** — See actual usage patterns beyond just activation
- **[Logs](../logs)** — Review activation/deactivation events in detail
- **[Settings > Retention Policies](../retention-policies)** — Configure auto-deactivation rules
...
- [License Keys](../licenses) - Manage licenses
- [Customers](../customers) - Customer management
- [Settings](../settings) - System configuration
- [Profile](../profile) - Your admin profile and security settings
