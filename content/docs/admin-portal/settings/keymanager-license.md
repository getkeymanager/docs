...
- [General Settings]({{< ref "/../../docs/docs/admin-portal/general" >}}) - Platform configuration
- [Telemetry Settings]({{< ref "/../../docs/docs/admin-portal/telemetry" >}}) - Usage reporting
- [Dashboard]({{< ref "/../../docs/docs/admin-portal/../dashboard" >}}) - View license status summary
