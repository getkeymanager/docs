...
- [Email Settings]({{< ref "/docs/docs/content/docs/admin-portal/email" >}}) - Configure email delivery
- [Logging Settings]({{< ref "/docs/docs/content/docs/admin-portal/logging" >}}) - Track system activities
