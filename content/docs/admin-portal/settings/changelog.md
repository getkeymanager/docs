...
- [General Settings]({{< ref "/docs/docs/content/docs/admin-portal/general" >}}) - Site-wide configuration
- [Email Settings]({{< ref "/docs/docs/content/docs/admin-portal/email" >}}) - Notification preferences
- [Webhooks]({{< ref "/docs/docs/content/docs/admin-portal/webhooks" >}}) - Automate changelog notifications
