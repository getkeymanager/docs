...
- [Logging Settings]({{< ref "/docs/docs/content/docs/admin-portal/logging" >}}) - General system logging configuration
- [Storage Settings]({{< ref "/docs/docs/content/docs/admin-portal/storage" >}}) - Overall storage management
- [Telemetry Settings]({{< ref "/docs/docs/content/docs/admin-portal/telemetry" >}}) - Event tracking and analytics
