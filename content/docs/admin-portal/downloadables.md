...
6. Customers access via [Client Portal > Downloads]({{< ref "/docs/docs/content/docs/admin-portal/../client-portal/downloads" >}})
...
**Where Files Are Stored:** AWS S3 or S3-compatible storage (configured in [Settings > S3]({{< ref "/docs/docs/content/docs/admin-portal/settings" >}}))
...
8. Save
9. Test downloads in [Client Portal]({{< ref "/docs/docs/content/docs/admin-portal/../client-portal/downloads" >}}) (admin view)
...
**Solution:** Check file size (may exceed limit). Verify S3 credentials in [Settings > S3]({{< ref "/docs/docs/content/docs/admin-portal/settings" >}}). Check internet connection. Try smaller file or compress.

**Problem:** Customers can't download files

**Solution:** Verify status is Published. Check S3 bucket permissions (files must be private, but system needs read access). Verify signed URL generation works. Check [Logs]({{< ref "/docs/docs/content/docs/admin-portal/logs" >}}) for errors.
...
* [Products]({{< ref "/docs/docs/content/docs/admin-portal/products" >}}) — Manage products that downloadables belong to
* [Client Portal > Downloads]({{< ref "/docs/docs/content/docs/admin-portal/../client-portal/downloads" >}}) — Customer view
* [Settings > S3]({{< ref "/docs/docs/content/docs/admin-portal/settings" >}}) — Configure file storage
