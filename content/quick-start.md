...
*   **Action**: Familiarize yourself with the [Dashboard]({{< ref "/docs/docs/content/docs/admin-portal/dashboard" >}}).
...
1.  Navigate to [Products]({{< ref "/docs/docs/content/docs/admin-portal/products" >}}) in the sidebar.
...
1.  Go to [API Keys]({{< ref "/docs/docs/content/docs/admin-portal/api-keys" >}}).
...
1.  Go to [Generators]({{< ref "/docs/docs/content/docs/admin-portal/generators" >}}) or directly to [Licenses]({{< ref "/docs/docs/content/docs/admin-portal/licenses" >}}).
...
*   **[License Lifecycle]({{< ref "/docs/docs/content/docs/license-lifecycle" >}})** — Learn about various license states.
*   **[Hardware Binding]({{< ref "/docs/docs/content/docs/usb-offline" >}})** — Lock licenses to specific machines.
*   **[Webhooks]({{< ref "/docs/docs/content/docs/admin-portal/webhooks" >}})** — Automate your workflow with real-time notifications.
*   **[API Endpoints]({{< ref "/docs/docs/content/docs/api/endpoints" >}})** — Explore full automation capabilities.
