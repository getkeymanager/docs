...
*   **[Admin Governance]({{< ref "/content/docs/admin-portal" >}})** — Complete control over products, generators, and licenses.
*   **[Multi-Framework SDKs]({{< ref "/docs" >}})** — Native support for Laravel, PHP, CodeIgniter, Node.js, and React.
*   **[Offline Validation]({{< ref "/content/docs/usb-offline" >}})** — Cryptographically sign licenses for air-gapped systems.
*   **[API-First Architecture]({{< ref "/content/docs/api" >}})** — Fully documented REST API for seamless automation.
*   **[Customer Self-Service]({{< ref "/content/docs/client-portal" >}})** — Let users manage their own activations and downloads.
